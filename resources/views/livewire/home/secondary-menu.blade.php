<div class="bg-transparent    text-light" style="padding: 0.4em;">
    {{-- If you look to others for fulfillment, you will never truly be fulfilled. --}}
    <div class="container-fluid">
        <div class="row">

            <div class="col-md-11">
                <i class="bi-telephone-fill text-light" style="font-size: 1rem;"></i> +255 755 63 19 07
                &nbsp; &nbsp;
                <i class="bi-envelope text-light" style="font-size: 1rem;"></i> 
                sales@geonetwork.co.tz
            </div>
