            ...
            <div class="col-md-12">
                <div class="row" style="margin-top: 1em; padding-left: 1.4em;">
                   <div class="card" style="width: auto;">
                    <h3 class="card-title" style="padding-top: 1em">
                        {{ Illuminate\Support\Str::limit($news->name, 25) }}
                        </h3>
                    ...
                    <div class="row" style="margin-top: 1em">
                       ...
                       <div class="card" style="width: auto;">
                          <div class="card-body">
                            ...
                            <a href="{{route('home-show-news',$news->id)}}" class="btn btn-outline-secondary rounded-pill" style="border-color: #33BAFA; color: #33BAFA;">View<a>
                          </div>
                        </div>
                   </div>
                @endforeach
